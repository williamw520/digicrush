...
let m4 = (function() {
    ...
    m4.scale        = (m, x, y, z)  => multiply(m, scale_mat(x, y, z));
    m4.translate    = (m, x, y, z)  => multiply(m, trans_mat(x, y, z));
    m4.rotatex      = (m, radian)   => multiply(m, rot_x_mat(radian));
    m4.rotatey      = (m, radian)   => multiply(m, rot_y_mat(radian));
    m4.rotatez      = (m, radian)   => multiply(m, rot_z_mat(radian));
    ...
    m4.project      = (w, h, d)     =>  [ 2/w,      0,      0,      0,
                                            0,   -2/h,      0,      0,
                                            0,      0,    2/d,      0,
                                           -1,      1,      0,      1,  ];

    // Create a 4x4 scale matrix, for scaling to the size (x,y,z)
