...
v3.unit     = (a)       => { let l=v2.len(a); return l > 0.000001 ? [  a[0]/l, a[1]/l, a[2]/l ] : [0, 0, 0] }   // the unit vector; avoid divide by 0.
v3.normal   = (a)       => { let l=v2.len(a); return l > 0.000001 ? [ -a[1]/l, a[0]/l, a[2]/l ] : [0, 0, 0] }   // the normal vector; perpendicular unit vector.
